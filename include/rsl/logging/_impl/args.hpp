...
#define RSL_DUMP_ARGS1(Offset)                                                                     \
  (Offset < rsl::_log_impl::FunctionScope<>::max_idx ? &[:rsl::_log_impl::FunctionScope<>::get(Offset + 0):] \
                                                : nullptr)
...
#define RSL_LOG_ARGS rsl::_log_impl::FunctionScope<>::capture_args(RSL_DUMP_ARGS16(0), RSL_DUMP_ARGS16(16), RSL_DUMP_ARGS16(32), RSL_DUMP_ARGS16(48))
#elif RSL_ARGDUMP_COUNT == 32
#define RSL_LOG_ARGS rsl::_log_impl::FunctionScope<>::capture_args(RSL_DUMP_ARGS16(0), RSL_DUMP_ARGS16(16))
#elif RSL_ARGDUMP_COUNT == 16
#define RSL_LOG_ARGS rsl::_log_impl::FunctionScope<>::capture_args(RSL_DUMP_ARGS16(0))
#elif RSL_ARGDUMP_COUNT == 8
#define RSL_LOG_ARGS rsl::_log_impl::FunctionScope<>::capture_args(RSL_DUMP_ARGS4(0), RSL_DUMP_ARGS4(4))
#else
